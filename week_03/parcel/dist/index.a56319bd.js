...
var _stagger = require("./animations/stagger");
(0, _stagger.staggerLists)();

},{"./animations/fade":"eRidF","./animations/stagger":"gaQsz"}],"eRidF":[function(require,module,exports) {
...
const fadeInUp = ($element, $duration, $delay)=>{
    return fade($element, {
...
},{}],"gaQsz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "staggerLists", ()=>staggerLists);
    ...
    entries.forEach((entry)=>{
        if (entry.isIntersecting) {
            ...
            $listItems.forEach(($listItem, i)=>{
                (0, _fade.fadeInUp)($listItem, 500, i * 100);
            });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./fade":"eRidF"}]},["4P6y2","bAabt"], "bAabt", "parcelRequire5b12")
